...
from pdxcodeguild.forms import PostForm, Contact, Comment
...
def student_comment(request):
    ...
    if request.method == 'GET':
        ...
        if form.is_valid():
            ...
            subject, from_email, to = 'A new student comment form has been filled out.', 'forms@pdxcodeguild.com', 'pdx-code-guild-admin@googlegroups.com'
            text_content = '''Name: %s
            Email address: %s
